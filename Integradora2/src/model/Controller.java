...
public class Controller {
	...
	public Controller() {
        ...
        projects[1] = new Project("Project2", "joshua", Calendar.getInstance(),Calendar.getInstance(), 20000000, "esteban", "9456789", months);

        projects[2] = new Project("Project3", "martin", Calendar.getInstance(),Calendar.getInstance(), 30000000, "pope", "987653456", months);
        ...
        registerKnowledgeUnite("9876543", "descripcon de la segunda capsula", 1, "daniel", "ceo", "#integradora# el importante que se hagan bien la integradora...", 1, 1);
	
        registerKnowledgeUnite("98765545678", "descripcon de la tercera capsula", 3, "sofia", "programador", "#Examen# el importante que se hagan bien los examenes...", 0,3);
        
        registerKnowledgeUnite("asdghj", "descripcon de la cuarta capsula", 4, "samuel", "supervisor", "#Controles# el importante que se hagan bien los controles...", 2, 1);
	}
